			...
			<tbody>
				...
				<tr>
					...
					<td><button class="btn btn-warning"> <a href="{{route('edit-user',$user->id)}}"> Sửa</a></button>
						<button type="button" class="btn btn-danger delete-product" data-toggle="modal" data-target="#delete" data-id="{{ $user->id }}">Xóa</button>
					</td>
					@else
					<td>N/A</td>
					@endif
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Bạn thật sự muốn xóa người này?</p>
			</div>
